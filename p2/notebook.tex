...
\textbf{Answer}: To inform business decisions I would consider the
following things:

useage disribution as a function of:

time of day, day of year,season,weather patterns Distribution and
central tendency of use time Customer segments and Customer demographics

Whether or not any service point is running out of bikes and when (time
of day, day of year) The main general questions come down to the classic
``Who, what, when, why, where.''

Who uses the bike share? How do they use it? Why do they use it? When do
they use it? Where do they use it (where do they pick up and return)?
Finally some more specific questoins would inlcude:

What are the demographics of each user? What is the most common day of
useage for subsribers, and customers? What is the most common time of
useage for subscribers and customers? What is the most common trip
duration?
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{def} \PY{n+nf}{print\PYZus{}first\PYZus{}point}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                ...
                \PY{n}{first\PYZus{}trip} \PY{o}{=}\PY{n}{trip\PYZus{}reader}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{k}{def} \PY{n+nf}{time\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
        \PY{l+s+sd}{    Takes as input a dictionary containing info about a single trip (datum) and}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                ...
                \PY{n}{d1} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{starttime}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{S}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} 
                \PY{n}{day\PYZus{}of\PYZus{}week}\PY{o}{=}\PY{n}{d1}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{A}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{k}{return} \PY{p}{(}\PY{n}{d1}\PY{o}{.}\PY{n}{month}\PY{p}{,} \PY{n}{d1}\PY{o}{.}\PY{n}{hour}\PY{p}{,} \PY{n}{day\PYZus{}of\PYZus{}week}\PY{p}{)}
            \PY{k}{elif} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n}{starttime} \PY{o}{=} \PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{starttime}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
                \PY{n}{d2} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{starttime}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} 
                \PY{n}{day\PYZus{}of\PYZus{}week}\PY{o}{=}\PY{n}{d2}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{A}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{k}{return} \PY{p}{(}\PY{n}{d2}\PY{o}{.}\PY{n}{month}\PY{p}{,} \PY{n}{d2}\PY{o}{.}\PY{n}{hour}\PY{p}{,} \PY{n}{day\PYZus{}of\PYZus{}week}\PY{p}{)}
            \PY{k}{elif} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n}{starttime} \PY{o}{=} \PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Start date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
                \PY{n}{d3} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{starttime}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} 
                \PY{n}{day\PYZus{}of\PYZus{}week}\PY{o}{=}\PY{n}{d3}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{A}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{k}{return} \PY{p}{(}\PY{n}{d3}\PY{o}{.}\PY{n}{month}\PY{p}{,} \PY{n}{d3}\PY{o}{.}\PY{n}{hour}\PY{p}{,} \PY{n}{day\PYZus{}of\PYZus{}week}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{k}{def} \PY{n+nf}{type\PYZus{}of\PYZus{}user}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    Takes as input a dictionary containing info about a single trip (datum) and}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{out\PYZus{}file}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{w}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}out}\PY{p}{,} \PY{n+nb}{open}\PY{p}{(}\PY{n}{in\PYZus{}file}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 ...
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{trip\PYZus{}reader}\PY{p}{:}
                     ...
                     \PY{n}{new\PYZus{}point}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{time\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{row}\PY{p}{,} \PY{n}{city}\PY{p}{)}
                     ...
                     \PY{n}{f\PYZus{}out}\PY{o}{.}\PY{n}{write}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{,}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{new\PYZus{}point}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{} Run this cell to check your work}
...
\textbf{Answer}: New York City has the highest number of trips(276081
total trips). NYC(New york) has the highest proportion of trips made by
subscribers(proportion of trips for new york is 89.06661450806104).
Chicago has the proportion of trips made by short-term
customers(proportion of trips for Chicago 23.774798630269924) .

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}31}]:} \PY{k}{def} \PY{n+nf}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 ...
                 \PY{n}{no\PYZus{}subscribers} \PY{o}{=} \PY{l+m+mi}{0}
                 \PY{n}{no\PYZus{}customers} \PY{o}{=} \PY{l+m+mi}{0}
                 ...
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                         \PY{n}{no\PYZus{}subscribers} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                     \PY{k}{elif} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                         \PY{n}{no\PYZus{}customers} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                 \PY{c+c1}{\PYZsh{} compute total number of rides}
                 \PY{n}{n\PYZus{}total} \PY{o}{=} \PY{n}{no\PYZus{}subscribers} \PY{o}{+} \PY{n}{no\PYZus{}customers}
                 \PY{n}{sub\PYZus{}proportion} \PY{o}{=} \PY{p}{(}\PY{n}{no\PYZus{}subscribers} \PY{o}{/} \PY{n}{n\PYZus{}total}\PY{p}{)} \PY{o}{*} \PY{l+m+mi}{100}
                 \PY{n}{cus\PYZus{}proportion} \PY{o}{=} \PY{p}{(}\PY{n}{no\PYZus{}customers} \PY{o}{/} \PY{n}{n\PYZus{}total}\PY{p}{)} \PY{o}{*} \PY{l+m+mi}{100}
                 \PY{c+c1}{\PYZsh{} return tallies as a tuple}
                 \PY{k}{return}\PY{p}{(}\PY{n}{no\PYZus{}subscribers}\PY{p}{,} \PY{n}{no\PYZus{}customers}\PY{p}{,} \PY{n}{n\PYZus{}total}\PY{p}{,} \PY{n}{sub\PYZus{}proportion}\PY{p}{,} \PY{n}{cus\PYZus{}proportion}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}32}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Modify this and the previous cell to answer Question 4a. Remember to run \PYZsh{}\PYZsh{}}
         ...
         \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
...
\textbf{Answer}: The average trip length for each city is
18.93(Washington), 16.56(Chicago), 15.81(NYC) (minutes). The proportion
of riders made in each city that are longer than 30 minutes are
10.83\%(Washington), 8.33\%(Chicago), 7.30\%(NYC).

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4b.                 \PYZsh{}\PYZsh{}}
        ...
        \PY{k+kn}{import} \PY{n+nn}{csv}
        \PY{k}{def} \PY{n+nf}{length\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
        \PY{k}{for} \PY{n}{datafile} \PY{o+ow}{in} \PY{n}{data\PYZus{}file}\PY{p}{:}
            \PY{n+nb}{print}\PY{p}{(}\PY{n}{length\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{datafile}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
42 minutes(41.67 minutes). The average time of subscribers taking rides
is 13 minutes(12.52 minutes).

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4c. If you have    \PYZsh{}\PYZsh{}}
         ...
         \PY{k}{def} \PY{n+nf}{duration\PYZus{}ridership}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}  
                 ...
                 \PY{n}{v\PYZus{}total} \PY{o}{=} \PY{l+m+mi}{0}
                 ...
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     ...
                     \PY{k}{if} \PY{n}{user\PYZus{}type} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                         ...
                         \PY{n}{v\PYZus{}total} \PY{o}{+}\PY{o}{=} \PY{n}{duration}
                     \PY{k}{elif} \PY{n}{user\PYZus{}type} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                         \PY{n}{b} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1} 
                         \PY{n}{y\PYZus{}total} \PY{o}{+}\PY{o}{=} \PY{n}{duration}
                 
                 \PY{n}{avg\PYZus{}sub} \PY{o}{=} \PY{n}{v\PYZus{}total} \PY{o}{/} \PY{n}{v}
                 \PY{n}{avg\PYZus{}cus} \PY{o}{=} \PY{n}{y\PYZus{}total} \PY{o}{/} \PY{n}{b}
                 
                 \PY{k}{return} \PY{p}{(}\PY{n}{v}\PY{p}{,} \PY{n}{b}\PY{p}{,} \PY{n}{avg\PYZus{}sub}\PY{p}{,} \PY{n}{avg\PYZus{}cus}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}30}]:} \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
         \PY{k}{for} \PY{n}{datafile} \PY{o+ow}{in} \PY{n}{data\PYZus{}file}\PY{p}{:}
             \PY{n+nb}{print}\PY{p}{(}\PY{n}{duration\PYZus{}ridership}\PY{p}{(}\PY{n}{datafile}\PY{p}{)}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{} load library}
        \PY{c+c1}{\PYZsh{} load library\PYZbs{}n\PYZdq{},}
        \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt}
            \PY{c+c1}{\PYZsh{} this is a \PYZsq{}magic word\PYZsq{} that allows for plots to be displayed\PYZbs{}n,}
            \PY{c+c1}{\PYZsh{} inline with the notebook. If you want to know more, see:,}
            \PY{c+c1}{\PYZsh{} http://ipython.readthedocs.io/en/stable/interactive/magics.html\PYZdq{},}
        \PY{o}{\PYZpc{}}\PY{k}{matplotlib} inline
            \PY{c+c1}{\PYZsh{} example histogram, data taken from bay area sample\PYZbs{}n\PYZdq{},}
...
and Customers for now: just collect all of the trip times and plot them.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}33}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to collect all of the trip times as a list \PYZsh{}\PYZsh{}}
         ...
         \PY{n}{trip\PYZus{}times} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} 
         \PY{n}{duration} \PY{o}{=} \PY{n}{trip\PYZus{}times}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
         \PY{n}{bins} \PY{o}{=} \PY{n}{py}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{100}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{)}
...
\textbf{Answer}: For subscriber group, the peak of trip durations is
5-10 minutes. For customer group, the peak of trip durations is 20-25
minutes. The shape of the distribution of trip durations for subscribers
is skewed to the right, with more points on the right side of the graph.
The shape of the distribution of trip durations for customers is more
likely to the normal distribution (bell-shape) compared to the former
one. But it is also skewed to the right.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}37}]:} \PY{n}{customers} \PY{o}{=} \PY{n}{trip\PYZus{}times}\PY{o}{.}\PY{n}{query}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type == }\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZdq{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{customers2} \PY{o}{=} \PY{n}{customers}\PY{o}{.}\PY{n}{query}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration \PYZlt{} 75}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{duration} \PY{o}{=} \PY{n}{customers2}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
         \PY{n}{bins} \PY{o}{=} \PY{n}{py}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{75}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{duration}\PY{p}{,} \PY{n}{bins}\PY{p}{)}
         \PY{n}{locations} \PY{o}{=} \PY{n}{bins} \PY{o}{+} \PY{l+m+mi}{5}
         ...
         \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{locations}\PY{p}{,} \PY{n}{labels}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}38}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 5. \PYZsh{}\PYZsh{}}
         ...
         \PY{n}{subscriber2} \PY{o}{=} \PY{n}{subscribers}\PY{o}{.}\PY{n}{query}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration \PYZlt{} 75}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{duration} \PY{o}{=} \PY{n}{subscriber2}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
         \PY{n}{bins} \PY{o}{=} \PY{n}{py}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{75}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)}
...
\textbf{Answer}: My Question: How many customers and subscribers are
there in these three cities? How about the proportion of customers and
subscribers in each city? What are the most popular days in the week for
customer and for subscribers in all the three cities? Does the average
duration of rides change depending on the day of the week?

Answer: (1)The number of the customers in these cities is respectively
30185(NYC), 17149(Chicago), 14573(DC). The number of the subscribers in
these cities is respectively 245896(NYC), 54982(Chicago), 51753(DC). NYC
is the largest bikeshare market in these three big cities, followed by
Chicago.
...
\setcounter{enumi}{1}
\item
  As for the proportion of customers and subscribers, Chicago has the
  largest proportion of customer, while NYC has the largest proportion
  of subscriber.
\item
  For customers overall, weekends (Saturday and Sunday) are the most
  popular days. For subscribers, weekdays (Monday to Friday) are more
  popular than weekends. We could make a guess here that subscribers
  always use bikeshare for commuting to work, while the users who do not
  use bikeshare for work use it at weekends for city travel
\item
  yes there is difference in average duration of rides change depending
  on the day of the week.as i mansioned above customer use more rides
  and they have high duration of usage as compared to subscribers.
\end{enumerate}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}39}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to continue to explore the dataset. \PYZsh{}\PYZsh{}}
         ...
         \PY{n}{dc} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         ...
         \PY{n}{chi\PYZus{}counts} \PY{o}{=} \PY{n}{chicago}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{p}{)}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{hour}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
         \PY{n}{dc\PYZus{}counts} \PY{o}{=} \PY{n}{dc}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{p}{)}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{hour}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{nyc\PYZus{}counts}\PY{p}{,} \PY{n}{chi\PYZus{}counts}\PY{p}{,} \PY{n}{dc\PYZus{}counts}\PY{p}{)}
\end{Verbatim}
...
Name: hour, dtype: int64
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}40}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} plot the counts}
         \PY{n}{nyc\PYZus{}bars} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{]}\PY{p}{,} \PY{n}{nyc\PYZus{}counts}\PY{p}{,} \PY{n}{width}\PY{o}{=}\PY{l+m+mf}{0.8}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{o}{.}\PY{l+m+mi}{7}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NewYork}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{chi\PYZus{}bars} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{]}\PY{p}{,} \PY{n}{chi\PYZus{}counts}\PY{p}{,} \PY{n}{width}\PY{o}{=}\PY{l+m+mf}{0.8}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{y}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{o}{.}\PY{l+m+mi}{7}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{dc\PYZus{}bars} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{6}\PY{p}{]}\PY{p}{,} \PY{n}{dc\PYZus{}counts}\PY{p}{,} \PY{n}{width}\PY{o}{=}\PY{l+m+mf}{0.8}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{b}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{o}{.}\PY{l+m+mi}{7}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Number of Customers (1\PYZhy{}3) and Subscribers (4\PYZhy{}6) in NewYork, Chicago and Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}41}]:} \PY{n}{nyc\PYZus{}totals} \PY{o}{=} \PY{n}{nyc}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{p}{)}
         \PY{n}{chi\PYZus{}totals} \PY{o}{=} \PY{n}{chicago}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{p}{)}
         \PY{n}{dc\PYZus{}totals} \PY{o}{=} \PY{n}{dc}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{p}{)}
         
         \PY{n}{nyc\PYZus{}pro} \PY{o}{=} \PY{n}{nyc\PYZus{}counts} \PY{o}{/} \PY{n}{nyc\PYZus{}totals}
         \PY{n}{chi\PYZus{}pro} \PY{o}{=} \PY{n}{chi\PYZus{}counts} \PY{o}{/} \PY{n}{chi\PYZus{}totals}
         \PY{n}{dc\PYZus{}pro} \PY{o}{=} \PY{n}{dc\PYZus{}counts} \PY{o}{/} \PY{n}{dc\PYZus{}totals}
         
         \PY{n}{nyc\PYZus{}pro\PYZus{}bars} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{]}\PY{p}{,} \PY{n}{nyc\PYZus{}pro}\PY{p}{,} \PY{n}{width}\PY{o}{=}\PY{l+m+mf}{0.8}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{o}{.}\PY{l+m+mi}{7}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NewYork}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{chi\PYZus{}pro\PYZus{}bars} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{]}\PY{p}{,} \PY{n}{chi\PYZus{}pro}\PY{p}{,} \PY{n}{width}\PY{o}{=}\PY{l+m+mf}{0.8}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{g}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{o}{.}\PY{l+m+mi}{7}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{dc\PYZus{}bars} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{6}\PY{p}{]}\PY{p}{,} \PY{n}{dc\PYZus{}pro}\PY{p}{,} \PY{n}{width}\PY{o}{=}\PY{l+m+mf}{0.8}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{b}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{o}{.}\PY{l+m+mi}{7}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Proportion of Customers (1\PYZhy{}3) and Subscribers (4\PYZhy{}6) in NewYork, Chicago and Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{n}{bike1} \PY{o}{=} \PY{n}{nyc}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{chicago}\PY{p}{)}
         \PY{n}{bike} \PY{o}{=} \PY{n}{bike1}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{dc}\PY{p}{)}
         ...
         \PY{n}{bike\PYZus{}day\PYZus{}pro\PYZus{}cus} \PY{o}{=} \PY{p}{(}\PY{n}{bike\PYZus{}day}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{/} \PY{n}{bike\PYZus{}total}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)} \PY{o}{*} \PY{l+m+mi}{100} \PY{c+c1}{\PYZsh{} calculate the percentage of day of use by user type}
         \PY{n}{bike\PYZus{}day\PYZus{}pro\PYZus{}sub} \PY{o}{=} \PY{p}{(}\PY{n}{bike\PYZus{}day}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{/} \PY{n}{bike\PYZus{}total}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)} \PY{o}{*} \PY{l+m+mi}{100}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{bike\PYZus{}day\PYZus{}pro\PYZus{}cus}\PY{p}{,} \PY{n}{bike\PYZus{}day\PYZus{}pro\PYZus{}sub}\PY{p}{)}
\end{Verbatim}
...
Tuesday       9.391507
Wednesday     9.517502
Name: hour, dtype: float64 day\_of\_week
Friday       15.373577
Monday       14.780606
Saturday     10.603435
Sunday        9.947509
...
Name: hour, dtype: float64
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}43}]:} \PY{n}{ind} \PY{o}{=} \PY{n}{py}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{bike\PYZus{}day\PYZus{}pro\PYZus{}cus}\PY{p}{)}\PY{p}{)}
         \PY{n}{width} \PY{o}{=} \PY{l+m+mf}{0.35}
         \PY{n}{cus\PYZus{}bar} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n}{ind}\PY{p}{,} \PY{n}{bike\PYZus{}day\PYZus{}pro\PYZus{}cus}\PY{p}{,} \PY{n}{width}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{g}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{sub\PYZus{}bar} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n}{ind}\PY{o}{+}\PY{n}{width}\PY{p}{,} \PY{n}{bike\PYZus{}day\PYZus{}pro\PYZus{}sub}\PY{p}{,} \PY{n}{width}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{b}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Proportion by day of week and user type (2,3 stands for Sat and Sun)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: Well this exercise made my python and visualization
techniques strong. however, i am learner and new to data science i dont
have deep knowledge about the fields but yes i would like to use this
skills in field of diamond sector where i can perform good analysis for
plotting and Visualizations for the different types of diamonds and the
different carets,colors and locations. and i would like to learn how and
in which way we can be more accurate with using statestics and making
predections.
...
\end{quote}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{k+kn}{from} \PY{n+nn}{subprocess} \PY{k}{import} \PY{n}{call}
